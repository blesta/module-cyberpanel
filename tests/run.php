...
<main role="main">
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <p>
                <a href="run.php?test=<?php echo $_GET['test']; ?>" class="btn btn-primary">
                    <?php echo Language::lang('Global.run.button.execute_again'); ?>
                </a>
                <a href="index.php" class="btn btn-secondary">
                    <?php echo Language::lang('Global.run.button.back'); ?>
                </a>
            </p>
        </div>
    </section>
    <div class="container">
        ...
        ?>
            <div class="text-danger" style="padding-bottom: 20px;">
                <h3>
                    <i class="fas fa-times-circle"></i> <?php echo Language::lang('Global.run.alert.fail_test'); ?>
                </h3>
            </div>
        <?php
        }
                    ...
                    <form method="post">
                        ...
                        <div class="float-right">
                            <button class="btn btn-primary btn-sm" type="submit">
                                <?php echo Language::lang('Global.run.button.execute_custom'); ?>
                            </button>
                        </div>
                    </form>
                </div>
