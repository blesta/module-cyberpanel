        ...
        <div class="container">
            ...
            <p>
                <a href="all.php" class="btn btn-primary">
                    <?php echo Language::lang('Global.all.button.execute_again'); ?>
                </a>
                <a href="index.php" class="btn btn-secondary">
                    <?php echo Language::lang('Global.all.button.back'); ?>
                </a>
            </p>
        </div>
    </section>
                ...
                if (!empty($results)) {
                    ...
                    ?>
                        <div class="row" style="padding: 10px 0px;">
                            <div class="col-md-8">
                                ...
                                ?>
                                    <strong class="text-success">
                                        <i class="fas fa-check-circle"></i> <?php echo Language::lang('Global.all.alert.success_test'); ?>
                                    </strong>
                                <?php
                                } else {
                                ?>
                                    <strong class="text-danger">
                                        <i class="fas fa-times-circle"></i> <?php echo Language::lang('Global.all.alert.fail_test'); ?>
                                    </strong>
                                <?php
                                }
                                ?>
                            ...
                            <div class="col-md-4">
                                <a href="run.php?test=<?php echo $name; ?>" class="btn btn-primary float-right">
                                    <?php echo Language::lang('Global.all.button.view_test'); ?>
                                </a>
                            </div>
                        </div>
                    <?php
