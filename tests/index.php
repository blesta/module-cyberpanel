        ...
        <div class="container">
            ...
            <p>
                <a href="all.php" class="btn btn-primary">
                    <?php echo Language::lang('Global.index.button.execute_all'); ?>
                </a>
                <a href="index.php" class="btn btn-secondary">
                    <?php echo Language::lang('Global.index.button.refresh_list'); ?>
                </a>
            </p>
        </div>
    </section>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <div class="row" style="padding: 10px 0px;">
                                ...
                                <div class="col-md-4">
                                    <a href="run.php?test=<?php echo $test['class']; ?>" class="btn btn-primary float-right">
                                        <?php echo Language::lang('Global.index.button.execute_test'); ?>
                                    </a>
                                </div>
                            </div>
                        <?php
